...
const Iphone = () => {
    return (
        <div className={`w-full h-full flex flex-col items-center justify-around bg-white p-8`}>
            <h3 className={`2xl:text-4xl xl:test-3xl md:text-2xl font-semibold text-gray-800 mb-8`}>
            ...
            <div className={'flex justify-between w-full'}>
                {iphoneModels.map((iphone) => (
                    <div key={Math.random()} className={`flex flex-col items-center justify-between gap-y-2`}>
                        ...
                        <span className={"2xl:text-base xl:test-sm lg:text-sm text-blue-400 mt-2"}>
                            {iphone.price}
                        </span>
